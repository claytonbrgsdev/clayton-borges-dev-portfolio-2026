  ...
  return (
    <section className="relative py-32 px-6 md:px-12" style={{ zIndex: 2 }}>
      <div className="mx-auto max-w-6xl grid md:grid-cols-2 gap-16 items-center">
        <div>
          <span className="font-sans text-xs tracking-widest uppercase opacity-40 block mb-6">
            {about_preview.label}
          </span>
          <h2 className="text-3xl md:text-5xl font-bold leading-tight mb-8">
            {about_preview.heading}
          </h2>
          <p className="font-sans opacity-60 leading-relaxed mb-8">{about_preview.body}</p>
          <Link
            href={`/${locale}/about`}
