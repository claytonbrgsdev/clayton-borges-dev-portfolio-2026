  ...
  return (
    <section className="relative py-40 px-6 md:px-12 border-t border-white/10 text-center" style={{ zIndex: 2 }}>
      <div className="mx-auto max-w-2xl">
        ...
        <p className="opacity-50 mb-10 text-lg">{contact_cta.body}</p>
        <Link
          href={`/${locale}/contact`}
          className="inline-block px-10 py-4 bg-white text-black font-mono text-sm tracking-wide hover:bg-white/90 transition-colors"
        >
          {contact_cta.cta} →
        </Link>
      </div>
